...
// modal works
$(function(){
  $("ul.workLine01 a img").each(function(){
...
// 画像のロールオーバー
  ...
  $('ul.workLine01 a img').hover(function(){
...
$(function(){
  ...
  if(agent.search(/iPhone/) !== -1 || agent.search(/iPad/) !== -1 || agent.search(/Android/) !== -1){
   $('#company03,#company04,#company05,#company06,#company07').css("background-size","contain");
  }
});
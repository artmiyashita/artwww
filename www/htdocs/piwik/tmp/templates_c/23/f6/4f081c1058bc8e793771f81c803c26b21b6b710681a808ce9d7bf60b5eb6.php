...
class __TwigTemplate_23f64f081c1058bc8e793771f81c803c26b21b6b710681a808ce9d7bf60b5eb6 extends Twig_Template
{
...
\t\t\t</span>
    ...
    <tr>
        ...
        // line 52
        echo "                ";
        $this->env->loadTemplate("@CoreHome/_siteSelect.twig")->display(array_merge($context, array("siteName" => (isset($context["defaultReportSiteName"]) ? $context["defaultReportSiteName"] : $this->getContext($context, "defaultReportSiteName")), "idSite" => (isset($context["defaultReportIdSite"]) ? $context["defaultReportIdSite"] : $this->getContext($context, "defaultReportIdSite")), "switchSiteOnSelect" => false, "showAllSitesItem" => false, "showSelectedSite" => true, "siteSelectorId" => "defaultReportSiteSelector")));
        // line 60
        echo "            </fieldset>
        </td>
    </tr>

...
<html><head><title>内容の確認</title></head>
...
<table width="100%" bgcolor="#FFFFFF">
                                                                <tr><br>
																  ...
																  当社は印刷物の企画・製作（外部委託を含む）を核として、あらゆるメディアを提供するために、情報の取得、加工、伝達を事業活動とします。<br>
                                                                    当社は、個人情報保護の理念を明確にし、次の事項を含む個人情報保護方針を定め、これを実行し維持します。また、社長はこの方針を文書化し、役員及び従業者に周知させると共に、ホームページなどで一般の人が入手可のうとします。 </p>                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                  <td colspan="2" class="style1"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                                    <tr valign="top" class="text-12px-2">
                                                                      ...
                                                                      <td valign="bottom" class="text-12px-2"><p class="style1"><span class="text-12px-2 style1">事業内容及び規模を考慮して個人情報の取得、利用、及び提供を行います。</span><br>
                                                                      </p>                                                                        </td>
                                                                    </tr>
                                                                    <tr valign="top" class="text-12px-2">
                                                                      <td>&nbsp;</td>
                                                                      <td class="text-12px-2">1)個人情報の取得は、当社の正当な事業の範囲内で取得目的を明確にし、その目的の達成に必要な限度において行い、目的外利用はしません。<br>
2)個人情報の利用及び提供は、本人が同意を与えた取得目的の範囲内で行います。  　　<br>
3)個人情報の受託は、じゅう分な個人情報の保護水準を満たしている事業者を選定し、当社の厳正な管理下で行います。<br>
4)個人情報の管理は、取得目的に応じ必要な範囲内において、正確に最新の状態で行います。  　　<br>
5)また、取得時に、利用目的の達成に必要な範囲外の添付されてきた個人情報は顧客或いは本人に返却します。 </td>
                                                                    </tr>
                                                                    <tr valign="top" class="text-12px-2">
                                                                      <td width="15"><font color="#666666">2.</font></td>
                                                                      <td class="text-12px-2"><p class="style1">役員と従業者すべてが、個人情報の取扱いに関する法令、国の定める方針その他の規範を遵守します。そのための定期的教育監督を実施します。</p></td>
                                                                    </tr>
                                                                    <tr valign="top" class="text-12px-2">
                                                                      <td width="15"><font color="#666666">3.</font></td>
                                                                      <td class="text-12px-2"><p class="style1">個人情報の漏洩、滅失または毀損の防止及び是正を行います。具体的方法については定期的に見直し、改善します。</p>                                                                        </td>
                                                                    </tr>
                                                                    <tr valign="top" class="text-12px-2">
                                                                      <td width="15"><font color="#666666">4.</font></td>
                                                                      <td class="text-12px-2 style1">個人情報について苦情及び相談の窓口を設置し、もうし出には迅速に対応します。</td>
                                                                    </tr>
                                                                    <tr valign="top" class="text-12px-2">
                                                                      <td width="15"><font color="#666666">5.</font></td>
                                                                      <td class="text-12px-2 style1">個人情報保護のための個人情報保護マネジメントシステムを制定し、効果的に実施されるよう定期的かつ継続的に教育し、見直し、改善します。 </td>
                                                                    </tr>
                                                                    <tr valign="top" class="text-12px-2">
                                                                      <td width="15">&nbsp;</td>
                                                                      <td>&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                  <td colspan="2" align="right" class="text-12px-2">アート印刷株式会社<br>
...
<BR>
<CENTER><INPUT TYPE=submit VALUE="個人情報保護方針に同意し送信する"></CENTER>
<BR>
<SCRIPT Language="JavaScript">
<!--
function PageBack(){
